...
$('.header').append('<a href="spreadtheword.html" class="nav-link">Spread the word</a>');
$('.header').append('<a href="getinvolved.html" class="nav-link">Get Involved</a>');
$('.header').append('<a href="greenivistmanifesto.html" class="nav-link">Greenivist Manifesto</a>');
$('.header').append('<a href="donate.html" class="nav-link">Donate</a>');
